    ...
    <div className="min-h-screen bg-white">
      ...
      <main className="mx-auto max-w-4xl px-6 py-12 sm:px-8">
        ...
        <section className="mb-12">
          ...
          <ul className="space-y-4">
            {[
              ...
              "To initiate a return, please contact us at support@beige-swallow-873243.hostingersite.com with your order details.",
        ...
        <section className="mb-12">
          ...
          <ul className="space-y-4">
            {[
              "Contact us at support@beige-swallow-873243.hostingersite.com within 3 days of delivery with order details and issue images.",
        ...
        >
          ...
          <ul className="space-y-3">
            {[
              ...
              "For exchange requests, contact support@beige-swallow-873243.hostingersite.com.",
